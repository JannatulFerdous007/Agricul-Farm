    ...
    <section class="header">
        ...
        <main id="app-container">
            ...
            <div id="temp">
                ...
                <p><span id="m">Min:</span id="m"><span id="temp-value">Temp&nbsp;</span><span
                        id="temp-unit">&#176C</span> &emsp;
                    <span id="m">Max:</span id="m"><span id="temp-value2">Temp&nbsp;</span><span
                        id="temp-unit2">&#176C</span>
                </p>
            </div>
            <!-- climate -->
            <div id="climate">
            ...
            const getWeather = async (city) => {
                try {
                    ...
                    if (id < 300 && id > 200) {
                        ...
                        tempicon.src = "images/rainy-day.png"
        ...
        <section class="footer">
            ...
            <div class="footer-row">
                ...
                <div class="footer-col">
                    <h1>Agricul Farm</h1>
                    <p>Ius case noluisse iracundia ne, mei no possim- <br> offendit explicari. Vel ea nulla doming
                        recteque.</p>
                </div>
